...
class LibraryCatalog {
    ...
    public Optional<Book> getDetailsByAuthor(String author) {
        return bookList.stream().filter(book -> book.author().equals(author) && book.available()).findFirst(); // returns first available book by a specific author
    }
...
//        System.out.println(myBook2.get().title()); NoSuchElementException
